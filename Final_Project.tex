...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|ll|}
		...
		KNN                 & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.98} & 0.975                                & \multicolumn{1}{l|}{0.81}                         & 0.79                                    & \multicolumn{1}{l|}{0.79}                         & 0.72                         & \multicolumn{1}{l|}{0.84}                         & 0.86                      \\ \hline
		Random Forest       & \multicolumn{1}{l|}{0.9}                          & 0.96                                 & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.83} & \cellcolor[HTML]{C0C0C0}0.84            & \multicolumn{1}{l|}{0.74}                         & 0.78                         & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.94} & \cellcolor[HTML]{C0C0C0}1 \\ \hline
		Neural Network      & \multicolumn{1}{l|}{0.95}                         & \cellcolor[HTML]{C0C0C0}0.99         & \multicolumn{1}{l|}{0.825}                        & 0.82                                    & \multicolumn{1}{l|}{0.74}                         & 0.78                         & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.94} & \cellcolor[HTML]{C0C0C0}1 \\ \hline
		Ensemble            & \multicolumn{1}{l|}{0.9}                          & 0.97                                 & \multicolumn{1}{l|}{0.54}                         & 0.58                                    & \multicolumn{1}{l|}{0.76}                         & 0.76                         & \multicolumn{1}{l|}{0.8}                          & 0.8                       \\ \hline
		Logistic Regression & \multicolumn{1}{l|}{0.88}                         & 0.88                                 & \multicolumn{1}{l|}{0.78}                         & 0.77                                    & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.81} & \cellcolor[HTML]{C0C0C0}0.82 & \multicolumn{1}{l|}{0.81}                         & 0.86                      \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|ll|}
		...
		Random Forest       & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}0.65} & 0.58                        \\ \hline
		Neural Network      & \multicolumn{1}{l|}{0.58}                         & 0.53                        \\ \hline
		Logistic Regression & \multicolumn{1}{l|}{0.58}                         & \cellcolor[HTML]{C0C0C0}0.7 \\ \hline
	\end{tabular}
\end{table}
\end{document}
