...
and F1 score increases to nearly 1 at ntree = 50. The more trees are trained, the more patterns would be capture by the Random Forest since each tree
	...
	\item \begin{itemize}
	      ...
	      \begin{table}[!h]
		      ...
		      \begin{tabular}{|l|l|l|}
			      ...
			      {[}64 100 10{]}   & 0.951538       & 0.983528 \\ \hline
			      {[}64 40 10{]}    & 0.945853       & 0.972386 \\ \hline
			      {[}64 20 20 10{]} & 0.930637       & 0.983614 \\ \hline
		      \end{tabular}
	      \end{table}
	\item \begin{itemize}
		      \item $\lambda = 0.1$
	      ...
	      \begin{table}[!h]
		      ...
		      \begin{tabular}{|l|l|l|}
			      \hline
			      Architecture      & Accuracy Score & F1 Score \\ \hline
			      {[}64 100 10{]}   & 0.962324       & 0.983614 \\ \hline
			      {[}64 40 10{]}    & 0.935222       & 0.977977 \\ \hline
			      {[}64 20 20 10{]} & 0.935483       & 0.983543 \\ \hline
		      \end{tabular}
	      \end{table}
\end{enumerate}
...
\begin{figure}[!h]
	...
	\caption{Cost J against the number of instances introduced with $\lambda=0.01, \alpha=0.01$}
	\label{fig:nn-digits}
\end{figure}
